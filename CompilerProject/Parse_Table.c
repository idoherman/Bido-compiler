...
//    parse_table->action_table[37][18].type = SHIFT_ACTION;
//    parse_table->action_table[37][18].state = 55;
//
//
//
//
...
//    parse_table->action_table[38][19].type = SHIFT_ACTION;
//    parse_table->action_table[38][19].state = 56;
//
//
//
//
...
//    parse_table->action_table[39][20].type = SHIFT_ACTION;
//    parse_table->action_table[39][20].state = 57;
//
//
//
//
...
//    parse_table->action_table[40][21].type = SHIFT_ACTION;
//    parse_table->action_table[40][21].state = 58;
//
//
//
//
...
//    parse_table->action_table[41][22].type = SHIFT_ACTION;
//    parse_table->action_table[41][22].state = 59;
//
//
//
//
...
//    parse_table->action_table[42][23].type = SHIFT_ACTION;
//    parse_table->action_table[42][23].state = 60;
//
//
//
//
...
//    parse_table->action_table[43][24].type = SHIFT_ACTION;
//    parse_table->action_table[43][24].state = 61;
//
//
//
//
...
//    parse_table->action_table[45][25].type = SHIFT_ACTION;
//    parse_table->action_table[45][25].state = 62;
//
//
//
//
...
//    parse_table->action_table[46][26].type = SHIFT_ACTION;
//    parse_table->action_table[46][26].state = 63;
//
//
//
//
...
//    parse_table->goto_table[55][10].state = 70;
//    parse_table->goto_table[55][11].state = 37;
...
//    parse_table->goto_table[56][11].state = 71;
//    parse_table->goto_table[56][12].state = 38;
...
//    parse_table->goto_table[57][12].state = 72;
//    parse_table->goto_table[57][13].state = 39;
...
//    parse_table->goto_table[58][13].state = 73;
//    parse_table->goto_table[58][14].state = 40;
...
//    parse_table->goto_table[59][14].state = 74;
//    parse_table->goto_table[59][15].state = 41;
...
//    parse_table->goto_table[60][15].state = 75;
//    parse_table->goto_table[60][16].state = 42;
...
//    parse_table->goto_table[61][16].state = 76;
//    parse_table->goto_table[61][17].state = 43;
...
//    parse_table->goto_table[62][18].state = 77;
//    parse_table->goto_table[62][19].state = 45;
...
//    parse_table->goto_table[63][19].state = 78;
//    parse_table->goto_table[63][20].state = 46;
